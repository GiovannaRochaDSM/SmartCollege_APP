      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Criar nova tarefa',
              style: AppNewTextStyles.mediumBalooTitle.copyWith(color: AppNewColors.darkBlue),
            ...
            CustomDropdown(
              ...
              items: const ['Atividade', 'Avaliação', 'Estudo'],
              onChanged: (value) {
                setState(() {
            ...
            CustomDropdown(
              ...
              items: const ['Pendente', 'Em progresso', 'Concluída'],
              onChanged: (value) {
                setState(() {
              ...
              children: [
                Expanded(
                  child: Text(
                    ...
                    style: AppNewTextStyles.mediumExtraLight.copyWith(color: AppNewColors.darkGray),
                  ),
                ),
                IconButton(
